...
import neil.rookieguide.R;
import neil.rookieguide.util.Util;
import neil.rookieguide.view.shape.Rect;
import neil.rookieguide.view.target.RookieContextVLP;
import neil.rookieguide.view.target.ViewGravity;
import neil.rookieguide.view.target.ViewTarget;
        ...
        for(RookieContextVLP rookieContextVLP : rookieContextVLPs){
         ...
         //   int id =  this.viewTargets[index].getView().getId();
            ...
            if(rookieContextVLP.getViewGravity() == ViewGravity.TOP){
                params = new AbsoluteLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT,location[0],location[1]- Util.dpToPx(110));

            }else if(rookieContextVLP.getViewGravity() == ViewGravity.BOTTOM){
                params = new AbsoluteLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT,location[0],location[1]+ Util.dpToPx(60));
            }
